...
public class Apuesta {
	...
	public String toString() {
		return "Apuesta \n" 
	          +"  nombre del apostador: "+apostante.getNombre()
	          +"  caballo al que apuesta: " +caballo.getNombre()
	          +"  jinete del caballo: " +caballo.getJinete().getNombre()
	          +"  importe apostado: "+importe;
	}
